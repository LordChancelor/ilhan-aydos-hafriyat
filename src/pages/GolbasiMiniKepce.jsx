...
const GolbasiMiniKepce = () => {
  return (
    <div className="container mx-auto mt-10 p-6 max-w-5xl">
      <Helmet>
        <title>Gölbaşı Mini Kepçe Kiralama | İlhan Aydos Hafriyat</title>
        <meta
          name="description"
          content="Gölbaşı'nda mini kepçe, ekskavatör ve hafriyat hizmetleri. Bahçe düzenleme, temel kazma ve kırım işleri için İlhan Aydos Hafriyat güvencesi."
        />
        <link rel="canonical" href="https://ankaramakinekiralama.com/golbasi-mini-kepce-kiralama" />
      </Helmet>
      ...
      <div className="bg-black/70 backdrop-blur-sm rounded-3xl p-8 md:p-10 shadow-2xl border border-white/10">
        <h1 className="text-3xl md:text-5xl font-bold text-yellow-400 mb-6 border-b border-zinc-600 pb-4">
          Gölbaşı Mini Kepçe Kiralama
        </h1>

        <div className="text-lg text-zinc-200 leading-relaxed space-y-4">
          <p>
            <strong className="text-white">Gölbaşı bölgesinde mini kepçe kiralama</strong>, ekskavatör kiralama, hafriyat ve kırım işleri için İlhan Aydos Hafriyat olarak sizlere profesyonel çözümler sunuyoruz.
          </p>

          <p>
            <strong className="text-white">Kazı, drenaj, kırım, kanal açma</strong> gibi işlerinizde Gölbaşı'na özel hızlı servis ve deneyimli operatör kadromuzla yanınızdayız. Geniş makine filomuzla hem küçük çaplı bireysel hem de büyük çaplı kurumsal projelerde çözüm ortağınız oluyoruz.
          </p>
          ...
          <p>
            <strong className="text-white">Gölbaşı mini kepçe kiralama</strong> hizmetinde hızlı fiyatlandırma, uygun maliyet ve kaliteli hizmet garantisi için hemen bizimle iletişime geçin.
          </p>
        </div>
      </div>
      ...
      <div className="bg-black/70 backdrop-blur-sm p-8 rounded-3xl border border-white/10 mt-8 shadow-xl">
        <h2 className="text-2xl font-semibold text-yellow-400 mb-4">
          Neden Gölbaşı'nda Bizi Tercih Etmelisiniz?
        </h2>
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-zinc-300">
          ...
          <li className="flex items-center gap-3 bg-white/10 p-4 rounded-xl">
            <span className="text-yellow-400 font-bold text-xl">🚀</span> Hızlı Servis
          </li>
          <li className="flex items-center gap-3 bg-white/10 p-4 rounded-xl">
...
export default GolbasiMiniKepce;